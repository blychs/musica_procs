...
orig_res = '0.1x0.1'
dst_res = 'fv09x1.25'
output_grid = '/glade/work/plichtig/gridfiles/Gridinfo_CAMSv5.1-f09-_c20210407.nc'
output_path = '/glade/scratch/plichtig/emis/CAMS5.3_FV09_test_sectors/'
...
def main():
    ...
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # Load
    list_of_emis = [input_path + item for item in pattern_of_filenames]
    ...
    weights = f'{output_grid[:-3]}_WEIGHTS_sectors.nc'
    try:
        os.remove(weights)
