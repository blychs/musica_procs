...
pattern_of_filenames = ['CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_so2_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_oc_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_bc_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_co_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_co14_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_co15_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_co16_v5.3_monthly.nc',
                        'CAMS-GLOB-ANT_Glb_0.1x0.1_anthro_co17_v5.3_monthly.nc']
...
# Load
list_of_emis = [input_path + sp for sp in pattern_of_filenames]
